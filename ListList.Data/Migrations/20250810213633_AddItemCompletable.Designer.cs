...
namespace ListList.Data.Migrations
{
    ...
    [Migration("20250810213633_AddItemCompletable")]
    partial class AddItemCompletable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ListList.Data.Models.Entities.HeaderEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("ListList.Data.Models.Entities.ListItemEntity", b =>
                {
                    b.HasOne("ListList.Data.Models.Entities.HeaderEntity", "ListHeader")
                        .WithMany("ListItems")
            ...
            modelBuilder.Entity("ListList.Data.Models.Entities.ShareLinkEntity", b =>
                {
                    b.HasOne("ListList.Data.Models.Entities.HeaderEntity", null)
                        .WithMany("ShareLinks")
                        .HasForeignKey("HeaderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
